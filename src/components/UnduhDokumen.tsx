  ...
  return (
    <section className="min-h-screen bg-gradient-to-br from-white via-white to-white py-24 px-6">
      <div className="max-w-6xl mx-auto">
        <h1 className="text-4xl font-bold mb-16 text-center text-black drop-shadow-lg tracking-tight">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-10">
          {dokumen.map((item, index) => (
            <Card
              key={index}
              className="relative bg-gradient-to-br from-blue-950 to-blue-800 border rounded-2xl shadow-md hover:shadow-xl transform hover:scale-[1.015] transition-all duration-300 ease-in-out overflow-hidden"
            >
              {/* Optional Gradient Border Overlay */}
              <div className="absolute -inset-[1px] bg-gradient-to-r from-blue-950 to-blue-800 rounded-2xl z-[-1]"></div>
